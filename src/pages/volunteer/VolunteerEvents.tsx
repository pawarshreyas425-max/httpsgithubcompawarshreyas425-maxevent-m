    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <Input placeholder="Search opportunities by title or venue..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10" />
        </div>
      ...
      {filteredEvents.length > 0 ? (
        ...
        <div className="text-center py-12"><Calendar className="w-16 h-16 text-gray-600 mx-auto mb-4" /><h3 className="text-lg font-medium text-white mb-2">No Volunteer Opportunities Found</h3><p className="text-gray-400">Try adjusting your search or filters.</p></div>
      )}
    </div>
  )
}
